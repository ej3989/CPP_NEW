...
void brouse(int superFlag, totalManager &King, Customer &nowUser,
            struct termio tbuf, struct termio oldtbufr,
...
int main() {
  ...
  cout << right << setw(80) << "홈페이지 접속을 원하시면 아무 키나 누르세요"
       << endl;
  cout << endl << endl << endl << endl << endl << endl << endl << endl;
  cout << "===================================================================="
          "=======";
  ...
  while (1) {
    ...
    cout << endl << endl << endl << endl << endl << endl << endl << endl;
    cout << right << setw(78)
         << "1. 일반 로그인 2. 관리자 로그인 3. 회원가입 4. 종료 :" << endl;
    cout << endl << endl << endl << endl << endl << endl << endl << endl;
    cout << "=================================================================="
            "=========";
    char m;
    ...
    case 2:
      ...
      if (nowUser.correct_psswd(tempID, tempPW)) {
        nclear();
        brouse(nowUser.checkAdmin(), King, nowUser, tbuf, oldtbuf,
               King.getcarlist());
      } else
